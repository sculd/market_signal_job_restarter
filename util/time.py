...
def get_now_str_in_tz(tz):
    '''
    get datetime.time of now in korean time zone.
    :return:
    '''
    return str(get_now_in_tz(tz))
...
def get_now_time_str_in_tz(tz):
    '''
    get datetime.time of now in korean time zone.
    :return:
    '''
    return str(get_now_time_in_tz(tz))

def get_today_in_tz(tz):
    '''
    :return: e.g: 2019-12-25
    '''
    return get_utcnow().astimezone(tz).date()

def get_today_str_in_tz(tz):
    '''
    :return: e.g: 2019-12-25
    '''
    return str(get_today_in_tz(tz))
